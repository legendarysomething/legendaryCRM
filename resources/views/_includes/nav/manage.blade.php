         ...
         <div class="sidebar-menu">
            <div class="sidebar-menu-inner">
               <header class="logo-env">
                  <!-- logo --> 
                  <div class="logo"> <a href="../main/index.html"> <img src="../../assets/images/logo@2x.png" width="120" alt="" /> </a> </div>
                  <!-- logo collapse icon --> 
                  <div class="sidebar-collapse">
                     <a href="index.html#" class="sidebar-collapse-icon">
               ...
               <ul id="main-menu" class="main-menu">
                  <li class="opened active has-sub">
                     <a href="../main/index.html"><i class="entypo-gauge"></i><span class="title">Dashboard</span></a> 
                     <ul class="visible">
                        <li> <a href="#"><span class="title fa fa-car">Home</span></a> </li>
                        <li> <a href="#"><span class="title">Ayyy</span></a> </li>
                        <li> <a href="#"><span class="title">End Lyf Kill Me</span></a> </li>
                        {{-- <li class="active"> --}}
