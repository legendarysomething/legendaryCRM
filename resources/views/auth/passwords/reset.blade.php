        ...
        <div class="login-header login-caret">
            <div class="login-content"> 
                ...
                <div class="login-progressbar-indicator">
                    <h3>43%</h3> <span>Resetting your password ...</span></div>
            </div>
        </div>
                ...
                <form method="post" role="form" action="{{ route('password.request') }}">
                    ...
                    <div class="form-steps">
                        <div class="step current" id="step-1">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon"> <i class="fa fa-lock"></i> </div> <input type="password" class="form-control" name="password" id="password" placeholder="New Password" autocomplete="off" /> </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
